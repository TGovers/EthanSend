...
//==============================================================================
Angry_ayayaAudioProcessorEditor::Angry_ayayaAudioProcessorEditor (Angry_ayayaAudioProcessor& p)
...
Angry_ayayaAudioProcessorEditor::~Angry_ayayaAudioProcessorEditor()
{
}

//==============================================================================
void Angry_ayayaAudioProcessorEditor::paint (Graphics& g)
{
...
void Angry_ayayaAudioProcessorEditor::resized()
{
...
void Angry_ayayaAudioProcessorEditor::sliderValueChanged(Slider* slider)
{
    if (slider == &mixSlider)
    {
