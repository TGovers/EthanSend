...
/**
 */
class Angry_ayayaAudioProcessor  : public AudioProcessor/*, public AudioProcessorValueTreeState::Listener*/

{
public:
    //==============================================================================
    Angry_ayayaAudioProcessor();
    ~Angry_ayayaAudioProcessor();
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Angry_ayayaAudioProcessor)
};
