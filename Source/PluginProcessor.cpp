...
//==============================================================================
Angry_ayayaAudioProcessor::Angry_ayayaAudioProcessor()
...
//==============================================================================
const String Angry_ayayaAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool Angry_ayayaAudioProcessor::acceptsMidi() const
{
...
bool Angry_ayayaAudioProcessor::producesMidi() const
{
...
bool Angry_ayayaAudioProcessor::isMidiEffect() const
{
#if JucePlugin_IsMidiEffect
    return true;
#else
...
double Angry_ayayaAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int Angry_ayayaAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
    // so this should be at least 1, even if you're not really implementing programs.
}

int Angry_ayayaAudioProcessor::getCurrentProgram()
{
    return 0;
}

void Angry_ayayaAudioProcessor::setCurrentProgram (int index)
{
}

const String Angry_ayayaAudioProcessor::getProgramName (int index)
{
    return {};
}

void Angry_ayayaAudioProcessor::changeProgramName (int index, const String& newName)
{
}

//==============================================================================
void Angry_ayayaAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void Angry_ayayaAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool Angry_ayayaAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
#if JucePlugin_IsMidiEffect
...
void Angry_ayayaAudioProcessor::updateFilter()
{
...
void Angry_ayayaAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
//==============================================================================
bool Angry_ayayaAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

AudioProcessorEditor* Angry_ayayaAudioProcessor::createEditor()
{
    return new Angry_ayayaAudioProcessorEditor (*this);
}

//==============================================================================
void Angry_ayayaAudioProcessor::getStateInformation (MemoryBlock& destData)
{
...
void Angry_ayayaAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new Angry_ayayaAudioProcessor();
}
