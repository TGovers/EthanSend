...
class Angry_ayayaAudioProcessorEditor  : public AudioProcessorEditor, Slider::Listener
{
public:
    Angry_ayayaAudioProcessorEditor (Angry_ayayaAudioProcessor&);
    ~Angry_ayayaAudioProcessorEditor();
...
private:
    ...
    Angry_ayayaAudioProcessor& processor;
    
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Angry_ayayaAudioProcessorEditor)
};
